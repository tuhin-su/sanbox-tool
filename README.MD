...
## 🧠 How SANBOX Works (Simple Explanation)
...
## 📁 Directory Structure (Inside Sandbox Folder)
...
## 🔐 Default Security Model (Safe by Default)
...
* `ro` → Read-only system (recommended)
* `isolated` → No system binaries at all
